...
def model_predict(context, question, model, tokenizer):
    ...
    # print('full_prompt', full_prompt, len(full_prompt))
...
def main(
    ...
    *,
    ...
    lora_path: Optional[Path] = Path(f"./out/lora/squad2_r16_new_loss/iter-31999-loss-0.1969-ckpt.pth"),
    ...
    with (lazy_load(checkpoint_path) as pretrained_checkpoint,
        ...
        print("adapter_checkpoint", adapter_checkpoint)
        ...
        for passage in group["paragraphs"]:
            ...
            for qa in passage["qas"]:
                ...
                if gt_answer != "" and model_answer != "":
                    f1_score += compute_f1(model_answer,gt_answer)
                    em_score += compute_exact_match(model_answer, gt_answer)
                    blue_score1 += sentence_bleu(gt_answer, model_answer, weights=(1, 0, 0, 0))
                ...
                if total_count % 5 == 0:
                    ...
                    logger.info(f"BLEU Score: {blue_score1/f1_count }\n")
