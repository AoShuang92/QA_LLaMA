...
def generate(
    ...
    # print('empty', empty.size()) 301, empty positions with value 0
    empty[:T] = idx
    idx = empty
    # print('idx', idx.size()) 301
    # print('idx', idx) 
    predict_probs = []
    ...
    for t in range(T, T_new):
        ...
        idx_cond = idx[:t]
        # print('idx_cond', idx_cond.size())
        # print('idx_cond', idx_cond)
        # if the sequence context is growing too long we must crop it at max_seq_length
        idx_cond = idx_cond if t <= max_seq_length else idx_cond[-max_seq_length:]
        # print('idx_cond2', idx_cond.size())

        # forward
        logits = model(idx_cond.view(1, -1))
        # print('logits', logits.size()) [1, idx_cond, 32000]
        logits = logits[0, -1] / temperature
        # print('logits1', logits.size()) torch.Size([32000])
